package com.mycompany.lab4server;
...
{
    //Константы.
    public static final String FILE_SETTINGS_PATH = "D:\\КАИ\\Java\\ЛР4\\Lab4Server\\FileSettings.txt";
    ...
    public static void main(String[] args){
        ...
        Lab4Server tcpServer = new Lab4Server(args);
        tcpServer.go();
    }
    
    public Lab4Server(String[] args){
        try
        {
