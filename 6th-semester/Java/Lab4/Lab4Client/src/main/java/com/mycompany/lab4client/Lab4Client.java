package com.mycompany.lab4client;
...
public class Lab4Client implements Runnable{
    //Константы.
    ...
    public Lab4Client(String s, String host, int port, File f_client_log){
        this.name = s;
        this.host = host;
        this.port = port;
...
//        }
        ...
        for (int i = 1; i <= CLIENT_COUNT; i++) {
            Lab4Client ja = new Lab4Client(name, host, port, f_client_log);
