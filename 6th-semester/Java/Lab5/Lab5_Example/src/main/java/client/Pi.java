...
public class Pi implements Task<BigDecimal>, Serializable {
    ...
    /**
     * Compute the value, in radians, of the arctangent of the inverse of the supplied integer to the specified
     * number of digits after the decimal point. The value is computed using the power series expansion for the
     * arc tangent:
     *
