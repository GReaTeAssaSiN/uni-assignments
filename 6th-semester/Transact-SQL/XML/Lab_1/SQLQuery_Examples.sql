...
--Пример 1. Получение XML-фрагмента, содержащего данные заказа при использовании фразы FOR XML в режиме RAW. 
...
--Пример 3. Те же самые данные, используя корневой элемент, определенный с помощью опции ROOT и изменения имени элемента 
