...
void TTrapeze::MoveTo(float dx_coordinate_base_point, float dy_coordinate_base_point)
{
	TQuadrilateral::MoveTo(dx_coordinate_base_point, dy_coordinate_base_point);
}

void TTrapeze::Free(TTrapeze*& ptr_obj_trapeze)
{
