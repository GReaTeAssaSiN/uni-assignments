...
void TQuadrilateral::MoveTo(float dx_coordinate_base_point, float dy_coordinate_base_point)
{
	setXPoint(getXPoint() + dx_coordinate_base_point);
	setYPoint(getYPoint() + dy_coordinate_base_point);
	m_base_point_x2 += dx_coordinate_base_point;
	m_base_point_y2 += dy_coordinate_base_point;
	m_base_point_x3 += dx_coordinate_base_point;
	m_base_point_y3 += dy_coordinate_base_point;
	m_base_point_x4 += dx_coordinate_base_point;
	m_base_point_y4 += dy_coordinate_base_point;
}
