...
void MenuForChoices()
{
	std::cout << "Что вы хотите сделать?" << std::endl <<
		...
		"8) Вывод текущего состояния массива на экран." << std::endl <<
		"9) Выход." << std::endl;
}
...
//Выбор пользователем стандартной сортировки Шелла или произвольной.
...
{
	bool shell_sort_exit{};//Выход из сортировки Шелла.
