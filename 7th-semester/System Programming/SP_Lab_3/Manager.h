...
public:
    ...
    void AddStringToToSN(QTableWidget* tableWidget_ToSN, const SymbolicNameTable& symbolic_table, const QString& symbolic_name, const QString& section);
    bool ChangeStringInToSN(QTableWidget *tableWidget_ToSN, const SymbolicNameTable& symbolic_table, const QString &symbolic_name, const QString &section);
    void AddStringToTM(QTableWidget* tableWidget_modTable, const QString& command_counter, const QString& section);
    void AddStringToOMH(QTableWidget* tableWidget_OMH, const QString& prog_name, const QString& load_address, const QString& length_programm);
