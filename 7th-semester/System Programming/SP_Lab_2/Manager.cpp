...
void Manager::ExportDataToTextEditSource(QTextEdit* textEdit_source, const int &ex_num){
    ...
    case 0://Только прямая адресация.
        this->LoadSourceAssemblerCodeLineToField(textEdit_source, {"Prog1", "START", "0", ""});
        this->LoadSourceAssemblerCodeLineToField(textEdit_source, {"", "JMP", "L1", ""});
        this->LoadSourceAssemblerCodeLineToField(textEdit_source, {"A1", "RESB", "10", ""});
        this->LoadSourceAssemblerCodeLineToField(textEdit_source, {"A2", "RESW", "20", ""});
        this->LoadSourceAssemblerCodeLineToField(textEdit_source, {"B1", "WORD", "4096", ""});
        ...
        this->LoadSourceAssemblerCodeLineToField(textEdit_source, {"L1", "LOADR1", "B1", ""});
        this->LoadSourceAssemblerCodeLineToField(textEdit_source, {"", "LOADR2", "B4", ""});
        this->LoadSourceAssemblerCodeLineToField(textEdit_source, {"", "ADD", "R1", "R2"});
        this->LoadSourceAssemblerCodeLineToField(textEdit_source, {"", "SAVER1", "B1", ""});
        this->LoadSourceAssemblerCodeLineToField(textEdit_source, {"", "END", "", ""});
        break;
...
void Manager::AddStringToTM(QTableWidget* tableWidget_modTable, const QString& command_counter){
